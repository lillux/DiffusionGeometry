...
from core.diffusion.carre_du_champ import carre_du_champ_graph, carre_du_champ_knn
from core.diffusion.diffusion_process import knn_graph, markov_chain
...
from operators.differential_operators.levi_civita import levi_civita_02_weak
